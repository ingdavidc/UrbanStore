...
export default function Footer() {
  ...
  const links = {
    ...
    ayuda: [
      ...
      { to: '/tallas', label: 'Guía de tallas' },
      { to: '/faq', label: 'Preguntas frecuentes' },
    ],
    pagos: ['MercadoPago', 'Addi', 'Sistecredito', 'Transferencia bancaria', 'Contra entrega'],
  }
      ...
      <div className={`container ${styles.top}`}>
        ...
        <div className={styles.brand}>
          ...
          <div className={styles.socials}>
            <a
              href="https://www.instagram.com/urban8store/"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="Instagram UrbanStore"
            >
            ...
            <a
              href="https://www.facebook.com/profile.php?id=100040627789772"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="Facebook UrbanStore"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            <a
              ...
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="WhatsApp UrbanStore"
            >
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div className={styles.col}>
          ...
          <ul className={styles.colLinks}>
            {links.tienda.map((l) => (
              <li key={l.to}><Link to={l.to} className={styles.colLink}>{l.label}</Link></li>
            ))}
          </ul>
        </div>
        ...
        {/* Métodos de pago */}
        <div className={styles.col}>
          <h3 className={styles.colTitle}>Métodos de pago</h3>
          <ul className={styles.paymentList}>
            {links.pagos.map((p) => (
              <li key={p} className={styles.paymentItem}>
